...
public class HeatGeneratorBlock extends ActivePreservedDataCustomHorizontalShapedBlock {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, BlockEntityInit.HEAT_GENERATOR, HeatGeneratorTE::tick);
    }
}
