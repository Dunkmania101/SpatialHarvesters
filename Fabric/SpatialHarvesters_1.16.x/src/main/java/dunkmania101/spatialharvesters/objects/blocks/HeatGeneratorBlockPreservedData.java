...
public class HeatGeneratorBlockPreservedData extends ActivePreservedDataCustomHorizontalShapedBlock {
    public HeatGeneratorBlockPreservedData(Properties properties) {
        super(properties,
                Stream.of(
