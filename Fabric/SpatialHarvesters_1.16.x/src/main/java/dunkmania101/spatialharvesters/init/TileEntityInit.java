...
public class TileEntityInit implements ModInitializer {
    public static final BlockEntityType<OreHarvesterTE> ORE_HARVESTER = registerBlockEntityType(
            BlockEntityType.Builder.create(OreHarvesterTE::new,
    ...
    public static final BlockEntityType<BioHarvesterTE> BIO_HARVESTER = registerBlockEntityType(
            BlockEntityType.Builder.create(BioHarvesterTE::new,
                    BlockInit.BIO_HARVESTER_1,
                    BlockInit.BIO_HARVESTER_2,
                    BlockInit.BIO_HARVESTER_3,
                    BlockInit.BIO_HARVESTER_4,
                    BlockInit.BIO_HARVESTER_5,
                    BlockInit.BIO_HARVESTER_6,
                    BlockInit.BIO_HARVESTER_7,
    ...
    public static final BlockEntityType<StoneHarvesterTE> STONE_HARVESTER = registerBlockEntityType(
            BlockEntityType.Builder.create(StoneHarvesterTE::new,
                    BlockInit.STONE_HARVESTER_1,
                    BlockInit.STONE_HARVESTER_2,
                    BlockInit.STONE_HARVESTER_3,
                    BlockInit.STONE_HARVESTER_4,
                    BlockInit.STONE_HARVESTER_5,
                    BlockInit.STONE_HARVESTER_6,
                    BlockInit.STONE_HARVESTER_7,
    ...
    public static final BlockEntityType<SoilHarvesterTE> SOIL_HARVESTER = registerBlockEntityType(
            BlockEntityType.Builder.create(SoilHarvesterTE::new,
                    BlockInit.SOIL_HARVESTER_1,
                    BlockInit.SOIL_HARVESTER_2,
                    BlockInit.SOIL_HARVESTER_3,
                    BlockInit.SOIL_HARVESTER_4,
                    BlockInit.SOIL_HARVESTER_5,
                    BlockInit.SOIL_HARVESTER_6,
                    BlockInit.SOIL_HARVESTER_7,
                    BlockInit.SOIL_HARVESTER_8
            ).build(null),
            "soil_harvester"
    );

    public static final BlockEntityType<SpecificMobHarvesterTE> SPECIFIC_MOB_HARVESTER = registerBlockEntityType(
            BlockEntityType.Builder.create(SpecificMobHarvesterTE::new,
                    BlockInit.SPECIFIC_MOB_HARVESTER
            ).build(null),
