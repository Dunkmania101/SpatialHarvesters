...
public class BlockEntityInit implements ModInitializer {
        public static final BlockEntityType<OreHarvesterTE> ORE_HARVESTER = registerBlockEntityType(
                        FabricBlockEntityTypeBuilder.create(OreHarvesterTE::new, BlockInit.ORE_HARVESTER_1,
        ...
        public static final BlockEntityType<BioHarvesterTE> BIO_HARVESTER = registerBlockEntityType(
                        FabricBlockEntityTypeBuilder.create(BioHarvesterTE::new, BlockInit.BIO_HARVESTER_1,
        ...
        public static final BlockEntityType<StoneHarvesterTE> STONE_HARVESTER = registerBlockEntityType(
                        FabricBlockEntityTypeBuilder.create(StoneHarvesterTE::new, BlockInit.STONE_HARVESTER_1,
        ...
        public static final BlockEntityType<SoilHarvesterTE> SOIL_HARVESTER = registerBlockEntityType(
                        FabricBlockEntityTypeBuilder.create(SoilHarvesterTE::new, BlockInit.SOIL_HARVESTER_1,
        ...
        public static final BlockEntityType<LootHarvesterTE> LOOT_HARVESTER = registerBlockEntityType(
                FabricBlockEntityTypeBuilder.create(LootHarvesterTE::new, BlockInit.LOOT_HARVESTER)
                        .build(null),
                "loot_harvester");

        public static final BlockEntityType<SpecificMobHarvesterTE> SPECIFIC_MOB_HARVESTER = registerBlockEntityType(
                        FabricBlockEntityTypeBuilder.create(SpecificMobHarvesterTE::new, BlockInit.SPECIFIC_MOB_HARVESTER)
                                        .build(null),
                        "specific_mob_harvester");

        public static final BlockEntityType<DarkMobHarvesterTE> DARK_MOB_HARVESTER = registerBlockEntityType(
                        FabricBlockEntityTypeBuilder.create(DarkMobHarvesterTE::new, BlockInit.DARK_MOB_HARVESTER)
                                        .build(null),
                        "dark_mob_harvester");

        public static final BlockEntityType<HeatGeneratorTE> HEAT_GENERATOR = registerBlockEntityType(
                        FabricBlockEntityTypeBuilder.create(HeatGeneratorTE::new, BlockInit.HEAT_GENERATOR).build(null),
                        "heat_generator");

        public static final BlockEntityType<DimensionalApplicatorTE> DIMENSIONAL_APPLICATOR = registerBlockEntityType(
                        FabricBlockEntityTypeBuilder.create(DimensionalApplicatorTE::new, BlockInit.DIMENSIONAL_APPLICATOR)
                                        .build(null),
